...
<head>
    ...
    <!--begin::Fonts-->
    <link rel="stylesheet" href="{{asset('font/family.css')}}" />
    <!--end::Fonts-->
...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        <!--begin::Logo-->
        <a href="index.html">
            <img alt="Logo" src="{{asset('images/login/logo.png')}}" width='20' height="auto" />
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <ul class="menu-nav">
                            ...
                            <li class="menu-item menu-item-{{ Request::is('dashboard*') ? 'active' : '' }}"
                                aria-haspopup="true">
                            ...
                            @can('isAdmin')
                            <li class="menu-item menu-item-{{ Request::is('user-management') ? 'active' : '' }}"
                                aria-haspopup="true">
                                <a href="/user-management" class="menu-link">
                                    <span class="svg-icon menu-icon">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                            <g id="Stockholm-icons-/-Communication-/-Group" stroke="none"
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="http://keenthemes.com/metronic" target="_blank"
                                class="text-dark-75 text-hover-primary">Fakultas | Peternakan</a>
                        </div>
                        <!--end::Copyright-->
                    </div>
                    <!--end::Container-->
    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-right p-10 offcanvas-off">
        ...
        <!--end::Header-->
        <!--begin::Content-->
        <div class="offcanvas-content pr-5 mr-n5 scroll ps ps--active-y" style="height: 644px; overflow: hidden;">
            <!--begin::Header-->
            <div class="d-flex align-items-center mt-5">
                ...
                <div class="d-flex flex-column">
                    <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{
                        auth()->user()->name }}</a>
                    <div class="text-muted mt-1">{{ auth()->user()->email }}</div>
                </div>
            </div>

            <div class="d-flex align-items-center justify-content-end flex-wrap m-2">
                <form action="{{ route('logout') }}" method="post">
                    @csrf
                    <button type="submit" class="btn btn-outline-success"
                        class="justify-content-end m-2">Logout</button>
                </form>
            </div>
            <!--end::Header-->
